classdef rl_agent_wind < matlab.System & matlab.system.mixin.Propagates ...
...
%     end
    ...
    methods(Access = protected)
        ...
        function resetImpl(obj)
            ...
            action_normalized = double(py.driver.act([0 0 0 0 0 0]));
            action_normalized = min([1.0], max([-1.0], action_normalized));
