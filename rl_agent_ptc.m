classdef rl_agent_ptc < matlab.System & matlab.system.mixin.Propagates ...
    ...
    properties
      sample_time = 5.0;
      input_range = [8.8 90.0; 900.0 1100.0];
    end
...
%     end
    ...
    methods(Access = protected)
        ...
        function resetImpl(obj)
            ...
            action_normalized = double(py.driver.driver([-1 -1 -1 -1], 0));
